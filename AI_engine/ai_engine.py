...
while iteration<max_iteration:
    ...
    Qvalues[previous_x[0]][previous_x[1]][way] = Qvalues[previous_x[0]][previous_x[1]][way]+ alpha*(order['reward']+(gamma*(np.max(Qvalues[current_x[0]][current_x[1]]) - Qvalues[previous_x[0]][previous_x[1]][way])))
    ...
    if (random.random()<epsilon):
        ...
        ## choose the way
        way = np.argmax(Qvalues[current_x[0]][current_x[1]])
    ## moving 
